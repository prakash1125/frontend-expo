...
const navigation = [
  ...
  { name: "IN_PLAY", href: "/in-play", current: false },
  { name: "IPL_CLUB", href: "/indian-premier-league", current: false },
  { name: "INDIAN_CASINO", href: "/indian-casino", current: false },
  { name: "LIVE_CASINO", href: "/live-casino", current: false },
                      ...
                      {navigation.map((item) => (
                        <Link
                          ...
                          className={classNames(
                            ...
                            "px-3 py-5 text-xs font-font-family font-bold text-[20px] text-skin-navtext hover:bg-skin-cardhead hover:text-skin-white "
                          )}
