                    ...
                    {sportsLiveData.map((data, index) => (
                        <div key={index} className='liveScore-table'>
                            <button
                                ...
                                className={`flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 ${expandedTables.includes(index) ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
