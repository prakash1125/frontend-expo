...
const MarketData = () => {
  ...
  return (
         ...
         <div className="rounded-md shadow-md w-full bg-[#22262a]">
          <div onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="flex w-full items-center bg-[#32383e] rounded-t-md justify-between p-3">
        ...
        {isDropdownOpen && (
          ...
          <div className="p-1 flex items-center flex-1  cursor-pointer select-none">
            ...
            <div className="flex justify-between w-full">
              <div className="w-32 font-medium text-[#cfd4d8] text-sm">Indian Premeier Leauge</div>
