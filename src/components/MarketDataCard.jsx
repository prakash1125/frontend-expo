                          ...
                          <>
                            <div className="inline-block flex-1  ">
                              <div className="flex drop-shadow-sm rounded-sm ">
                                <div
                                  className={`w-[100%] py-1.5 rounded-md m-1 flex justify-center text-md font-bold text-skin-blue  bg-skin-oddsCardBlue  cursor-pointer`}
                                >
                                ...
                                <div
                                  className={`w-[100%] py-1.5 rounded-md m-1 flex justify-center text-md font-bold text-skin-pink  bg-skin-oddsCardPink   cursor-pointer`}
                                >
                                  <span className="m-auto brightness-125">
                                    {Object.values(exist)[0]?.runners[0]?.ex
