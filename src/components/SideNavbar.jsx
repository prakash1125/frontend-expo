...
import { getSport, getAllSportData, globalSportData } from "../redux/actions"
...
export const SideNavbar = () => {
  ...
  useEffect(() => {
  console.log(data,"zzzzzzzzzzzzzccccccccccccccccccc");
                  ...
                  < div  onClick={() => toggleDropdown(index)} className="justify-between pl-3 pr-4 rounded-md py-3 hover:bg-skin-hovercolorsecondary flex w-full">
                    ...
                    <div>
                      <div
                        ...
                        className="text-skin-secondary block text-[12px] font-semibold"
                      >
                        {league?.leagueName}
                      </div>
